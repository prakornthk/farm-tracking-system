...
export default function Login() {
  ...
  const handleLineLogin = () => {
    ...
    window.location.href = `https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=${clientId}&redirect_uri=${redirectUri}&scope=openid%20profile&state=random-state`;
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-green-100 p-4">
      <div className="card max-w-sm w-full p-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-green-800 mb-2">Farm Admin</h1>
        <p className="text-gray-500 text-sm mb-8">ระบบจัดการฟาร์มอัจฉริยะ</p>

        <button
          onClick={handleLineLogin}
          className="w-full flex items-center justify-center gap-3 bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200"
        >
